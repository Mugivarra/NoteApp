...
namespace NoteApp.View
{
    partial class AboutForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.AuthorLabel.Size = new System.Drawing.Size(250, 18);
			this.AuthorLabel.TabIndex = 0;
			this.AuthorLabel.Text = "Author: Mikhail Shchelupanov";
			// 
			// CcLabel
			// 
			...
			this.CcLabel.Size = new System.Drawing.Size(211, 17);
			this.CcLabel.TabIndex = 0;
			this.CcLabel.Text = "2022 Mikhail Shchelupanov©";
			// 
			// EmailLabel
			// 
			...
			this.EmailLinkLabel.Size = new System.Drawing.Size(136, 17);
			this.EmailLinkLabel.TabIndex = 1;
			this.EmailLinkLabel.TabStop = true;
			this.EmailLinkLabel.Text = "shlp.mkhl@mail.ru";
			// 
			// GitLinkLabel
			// 
			...
			this.GitLinkLabel.Size = new System.Drawing.Size(228, 17);
			this.GitLinkLabel.TabIndex = 1;
			this.GitLinkLabel.TabStop = true;
			this.GitLinkLabel.Text = "github.com/Mugivarra/NoteApp";
			// 
			// AboutForm
			// 
